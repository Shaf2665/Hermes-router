...
> The `:cli` image also bundles the [Hall of Wisdom bridge](hall-of-wisdom.md) and the
> [Hermes Coding Runtime](hermes-agent-runtime.md), so `docker exec hermes-router hr hall detect`
